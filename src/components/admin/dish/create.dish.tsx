import { createDishAPI, getCategoryAPI, uploadFileAPI } from '@/services/dish.api';
...
const CreateDish = ({ isOpenCreate, setIsOpenCreate, refreshTable }: IProps) => {
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        ...
        const res = await createDishAPI(requestData);
        if (res?.data) {
